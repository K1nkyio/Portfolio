...
export function Header() {
  ...
  // Keep hero transparency only in dark mode; light mode needs solid contrast.
  const isTransparent =
    location.pathname === '/' && !isScrolled && resolvedTheme === 'dark';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="w-1/2 border-l border-border/60 bg-background"
              >
                <SheetTitle className="sr-only">Navigation Menu</SheetTitle>
                <SheetDescription className="sr-only">
                  Site navigation links for Home, Projects, About, and Contact.
                </SheetDescription>
